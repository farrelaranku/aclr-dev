...
$commands = @(
    # "python -u run_open_net.py --is_training 1 --root_path ./dataset/weather/ --data_path weather.csv --model_id new_weather_96_96_noACLR_b128 --model B6iFast --data custom --features M --seq_len 96 --label_len 48 --pred_len 96 --e_layers 3 --d_layers 1 --factor 3 --enc_in 21 --dec_in 21 --c_out 21 --des 'Exp' --batch_size 128 --checkpoint ./checkpoints/ --train_epochs 20"
