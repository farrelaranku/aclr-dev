...
from models import Informer, Autoformer, AutoformerMod2, Bautoformer, Uautoformer, Transformer, Reformer, iTransformer
...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        result_path = self.args.checkpoints + setting + '/train_results/'
        ...
        for epoch in range(self.args.train_epochs):
            ...
            with open(f'{result_path}/log.txt', 'a') as f:
                f.write(
    ...
    def test(self, setting, test=0):
        ...
        #     fname = setting +"_preds_col_" + str(col) + ".csv"
        #     np.savetxt(fname, preds[:,:,col],delimiter=",")
        #     fname = setting +"_trues_col_" + str(col) + ".csv"
            # np.savetxt(fname, trues[:,:,col],delimiter=",")


        # fname = "ZZZ_Autoformer_ETTm2_pl"+str(self.args.pred_len)+"_preds.dat"
        # preds.tofile(fname)
